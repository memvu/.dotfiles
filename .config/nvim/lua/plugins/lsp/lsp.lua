return {
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    dependencies = {
      ...
      },
      {
        ...
        opts = {
          ...
          -- Server configurations are registered and enabled explicitly below.
    ...
    config = function()
      ...
      -- Build clangd's process arguments separately from compiler arguments.
      ...
      if nproc and nproc > 1 then
        vim.list_extend(clangd_cmd, { '-j', tostring(nproc - 1) })
      end
      ...
      -- Apply shared capabilities and per-server overrides through Neovim's
      -- native LSP API, then enable the complete configured server set.
